    ...
    <body id="login-page">
      <div class="selectStyle">
        ...
        <el-form class="login-container" label-position="left" label-width="0px">
            ...
            <el-form-item>
                <el-input type="text" v-model="loginForm.loginName" prefix-icon="el-icon-user" auto-complete="off" placeholder="账号">
                </el-input>
            </el-form-item>
            <el-form-item>
          ...
          <div class="smallButton">
            <span style="width: 80px;line-height: 40px;align-content: center;font-size: medium;margin-left: 5px">记住密码</span>
              <el-switch v-model="rememberThePassword" style="width: 50px;line-height: 40px;align-content: center;margin-top: 10px"></el-switch>
            <span class="downloadPlug">下载插件</span>
          </div>
        </el-form>
    </body>
</template>
...
<script>
    import { login } from '../../api/accountData';
    export default {
        name: 'Login',
        data() {
            return {
...
<style scoped>
    ...
    body {
        margin: 0px;
      background-image:url(../../assets/images/wallhaven-5dyk37.jpg);
